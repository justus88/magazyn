/*
  ...
  - You are about to drop the column `barcode` on the `Part` table. All the data in the column will be lost.
  - You are about to drop the column `manufacturer` on the `Part` table. All the data in the column will be lost.
